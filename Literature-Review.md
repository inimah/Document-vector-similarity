...
| \[6]. (Santos & Ganti, 2014) | word-level embedding &amp; character-level embedding; Averaging word vector | <ul><li>**Datasets**: short texts of sentiment analysis domain from moview review &amp; twitter</li></ul>  | <ul><li>This character-level embedding as convolutional layer, probably as same as stemming then?</li></ul> |
