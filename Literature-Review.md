...
| \[12]. (Kusner, et al., 2015) | word-to-word similarity, closeness of word-pairs, minimal distance, moving distance | <ul><li>Aims to address challenge: similarity between uncommon words and synonym that is not addressed by frequency-based vector representation (e.g. name of people vs. their title: President, Prime Minister)</li><li>text documents as weighted point of embedded words</li><li>calculating minimum cumulative distance</li><li>Evaluating distance with knn classifier</li></ul>   | |
