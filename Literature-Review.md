...
\[9]. <ul><li>Interesting! I was also thinking to do similar approach - 3 years afterwards duh! the authors adopt the concept of canonical correlation analysis (i.e. to examine relationship between 2 multivariate sets of variables - in this case is 2 pair of Q&amp;A sentences), which means we need to define fixed length of n words within a sentence and then find correlation matrix between pair of sentences as a square matrix input of NN to predict matching (similarity) score of these 2 sentences </li></ul>
