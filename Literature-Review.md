...
| \[6]. (Santos & Ganti, 2014) | word-level embedding &amp; character-level embedding; Averaging word vector | <ul><li>**Datasets**: short texts of sentiment analysis domain from moview review &amp; twitter</li></ul>  | |
