...
| \[10]. (Zhang & LeCun, 2015) | K-means clustering, temporal CNN |<ul><li>The authors apply CNN for ontology classification, sentiment analysis, and text categorization</li></ul>|
